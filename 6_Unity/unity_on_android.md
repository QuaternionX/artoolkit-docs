---
uri: artoolkit-for-unity-on-android
meta_title: ARToolKit for Unity on Android
menu_title: For Android
description: "When exporting to Android, some Player Settings must be configured as follows to work correctly with ARToolKit for Unity."
---
